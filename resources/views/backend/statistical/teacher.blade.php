            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Thống kê % KLTN hoàn thành hoặc không hoàn thành theo năm</h3>
                ...
                <div class="col-xs-6">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Thống kê khóa luận</h3>
        ...
        $(function () {
            ...
            var studentGraduation = new Chart(studentGraduation, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: ["Sinh viên"],
                        data: [{{$registrationUser}}, {{$confirmUser}}, {{$finishUser}}, {{$failUser}}, 0, {{$allUser}}],
                        backgroundColor: [
                            '#d7d7d7',
                            '#f50',
                            '#008d4c',
