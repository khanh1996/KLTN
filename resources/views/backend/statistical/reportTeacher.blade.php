            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form method="GET" enctype="multipart/form-data" action="{{route('backend.statistical.reportTeacher')}}" >
                                {{csrf_field()}}
                                <div class="row">
                                <!-- Khoa -->
                                    <!-- Ngành -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="department" name="department" style="width: 100%;">
                                                ...
                                                @foreach($arrayDepartment as $key => $value)
                                                    <option value="{{$key}}" {{Request::get('department') == $key ? 'selected' : ''}} >{{$value}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" style="margin-top: 24px;">
                                            <div class="input-group">
                                                <a href="{{route('backend.statistical.reportTeacher')}}" class="btn btn-default">Làm mói</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--Tìm kiếm-->
